...
export default function Offers(){
    return(
        <main className="w-full flex justify-center items-center max-w-screen-2xl mx-auto  mt-1 sm:mr-4">
            <div className="w-[90%] h-full sm:h-[120px] md:ml-20  bg-black text-white flex flex-col sm:flex-row justify items-center px-12  rounded-[15px] ">
