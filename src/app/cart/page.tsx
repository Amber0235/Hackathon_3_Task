...
const Page = () => {
  ...
  return (
    ...
    <div className="w-[95%] max-w-[1200px]  ">
          ...
          <div className=" sm:w-full  flex flex-col lg:flex-row justify-center items-start gap-4 p-5">
                  <Cartpage/>
                  {/* right */}
                    {/* Order Summary */}
                         <div className="bg-white p-2 w-full lg:w-[350px] border rounded-[20px]">
